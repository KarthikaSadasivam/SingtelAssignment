...
the rooster.
    ...
    lives near a Duck? Or near a phone that rings frequently?       **`Implemented All the Dog,Cat,rooster,duck to inherit its sound property .`**
...
2. Can you specialize the fish as a Shark and as a Clownfish?
  ...
  -->  Created Super Fish Class which implements swimmable interface,it has properties size and color to differentiate it as shark and clownfish

3. Dolphins are not exactly fish, yet, they are good swimmers
-->Created Dolphin calss which implements Swimmable interface
